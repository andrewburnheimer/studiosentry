<System.ComponentModel.RunInstaller(True)> Partial Class ProjectInstaller
    ...
    Private Sub InitializeComponent()
        ...
        'ServiceInstaller
        '
        Me.ServiceInstaller.Description = "Detects when RemoteApp users are connected, and disconnects them, on command"
        Me.ServiceInstaller.ServiceName = "Studio Sentry"
